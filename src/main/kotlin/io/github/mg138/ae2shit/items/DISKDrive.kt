package io.github.mg138.ae2shit.items
...
import io.github.mg138.ae2shit.disk.DISKCellHandler.getCellInventory
import io.github.mg138.ae2shit.disk.DISKCellInventory
import io.github.mg138.ae2shit.disk.DISKCellItem
import io.github.mg138.ae2shit.items.DISKDrives.diskSettings
...
class DISKDrive(
    ...
    companion object {
        ...
        fun addDiskInfo(item: DISKCellItem, itemStack: ItemStack, tooltip: MutableList<Text>,) {
            tooltip.add(Text.translatable("disk.${AE2Shit.MOD_ID}.desc").styled { it.withColor(Formatting.AQUA).withItalic(true) })
